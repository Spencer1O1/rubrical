...
A rubric-aware preflight checker for student assignments. See [README.md](./README.md) for the full specification.
...
- TypeScript browser extension (Phase 2+)
...
See README §14 for the full MVP build order.
